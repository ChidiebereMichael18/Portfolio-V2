    ...
    <div>
      ...
      <div className="md:mx-20 mx-10 mt-15 font-lato ">
        <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-4 grid-cols-1">
          <div className="px-12 py-12 bg-[#061417] mb-4 hover:border-b-amber-50 border hover:opacity-50 hover:shadow-xl shadow-textGreen/15">
          ...
          <div className="px-12 py-6 bg-[#061417] mb-4 hover:border-b-amber-50 border hover:opacity-50 hover:shadow-xl shadow-textGreen/15 ">
